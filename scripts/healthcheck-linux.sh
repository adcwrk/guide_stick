...
for dir in config documents logs backups reports data/chroma data/rag/corpus data/guide/profile data/guide/inventory data/guide/incidents data/guide/communications data/guide/situational_awareness data/guide/maps data/anythingllm data/openwebui scripts ollama; do
