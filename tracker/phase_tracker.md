...
| Future | Offline library UI and RAG | Critical path active: T029 next | Backlog epic E15; `reports/iiab_library_import_report.md`; `reports/rag_corpus_extraction_report.md`; `reports/rag_index_report.md`; `tracker/critical_path.md` |
