...
| Future | GUIDE preparedness and operations platform | Critical path active: T025 next | Backlog epic E16; `reports/guide_product_vision.md`; `reports/household_profile_schema_report.md`; `reports/inventory_schema_report.md` |
