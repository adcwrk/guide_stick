...
| Future | GUIDE preparedness and operations platform | Critical path active: T026 next | Backlog epic E16; `reports/guide_product_vision.md`; `reports/household_profile_schema_report.md`; `reports/inventory_schema_report.md`; `reports/incident_records_report.md` |
